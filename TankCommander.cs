...
{
    [Info("Tank Commander", "k1lly0u", "0.1.10")]
    ...
    class TankCommander : RustPlugin
    {
        ...
        private object OnRunPlayerMetabolism(PlayerMetabolism metabolism, BaseCombatEntity entity)
        {
            ...
            if (player == null || !commanders.ContainsKey(player.userID))
                return null;
        ...
        private void Unload()
        {
            ...
            Controller[] objects = UnityEngine.Object.FindObjectsOfType<Controller>();
            if (objects != null)
            {
                foreach(Controller obj in objects)
        ...
        private void OpenTankInventory(BasePlayer player, Controller controller)
        {
        ...
        private class Controller : MonoBehaviour
        {
            ...
            private void CheckOtherInput()
            {
                ...
                {
                    BasePlayer passenger = passengers[i];
            ...
            private void AdjustAiming()
            {
                ...
                float adjustedY = aimAngle.y + player.transform.rotation.eulerAngles.y + entity.transform.rotation.eulerAngles.y;
        ...
        {
            CuiElementContainer container = UI.ElementContainer(uiHealth, "0.95 0.95 0.95 0.05", new UI4(0.69f, 0.1f, 0.83f, 0.135f));
        ...
        private void CreateMGAmmoUI(BasePlayer player, Controller controller)
        {
            ...
            {
                CuiElementContainer container = UI.ElementContainer(uiAmmoMg, "0.95 0.95 0.95 0.05", new UI4(0.69f, 0.060f, 0.83f, 0.096f));
        ...
        private void CreateRocketAmmoUI(BasePlayer player, Controller controller)
        {
            ...
            {
                CuiElementContainer container = UI.ElementContainer(uiAmmoRocket, "0.95 0.95 0.95 0.05", new UI4(0.69f, 0.021f, 0.83f, 0.056f));
