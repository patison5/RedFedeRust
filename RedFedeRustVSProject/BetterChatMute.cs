    ...
    internal class BetterChatMute : CovalencePlugin
    {
        ...
        private void Loaded()
        {
            ...
            lang.RegisterMessages(new Dictionary<string, string>
            {
                ...
                ["No Reason"] = "<color=#FFEB3B>Unknown reason</color>",
                ["Muted"] = "<color=#FFEB3B>{player}</color> was muted by <color=#FFEB3B>{initiator}</color>: {reason}.",
                ["Muted Time"] = "<color=#FFEB3B>{player}</color> was muted by <color=#FFEB3B>{initiator}</color> for <color=#FFEB3B>{time}</color>: {reason}.",
                ["Unmuted"] = "<color=#FFEB3B>{player}</color> was unmuted by <color=#FFEB3B>{initiator}</color>.",
                ["Not Muted"] = "<color=#FFEB3B>{player}</color> is currently not muted.",
                ["Mute Expired"] = "<color=#FFEB3B>{player}</color> is no longer muted.",
                ...
                ["Player Name Not Found"] = "Could not find player with name <color=#FFEB3B>'{name}'</color>",
                ["Player ID Not Found"] = "Could not find player with ID <color=#FFEB3B>'{id}'</color>",
