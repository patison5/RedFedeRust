...
namespace Oxide.Plugins
{
    ...
    {
        [PluginReference]
        private Plugin SwapCoins, HeadHunter;
        //////////////////////////////////////////////////////
        ///  Fields
        //////////////////////////////////////////////////////
        ...
        [PluginReference]
        private Plugin Kits, Waypoints, Vanish, TestMarker;
        ...
        private void OnPlayerInput(BasePlayer player, InputState input)
        {
            ...
            for (var i = 0; i < hitpoints.Length; i++)
            {
                ...
                if (humanPlayer != null)
                {
                    ...
                    var id = Int32.Parse(humanPlayer.player.UserIDString);

                    if (id == 649272945) {   
                        SwapCoins.Call("DrawGui", player);
                    } else if (id == 556128495) {
                        HeadHunter.Call("pidor", player);
                    } else if (id == 1453672018) {
                        TestMarker.Call("DrawStoreGUI", player);
                    }
